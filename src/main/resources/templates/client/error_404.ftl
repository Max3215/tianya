...
<div class="prompt_page">
	<div class="register_ok">
		<div class="h200"></div>
		<img src="/client/images/cry.png">
		<h1>抱歉，您查看的商品不存在，可能已经下架或被转移</h1>
		<div>
			<label class="la1"><a href="javascript:history.go(-1);">返回</a></label>
			<label class="la2"><a href="/">天涯首页</a></label>
		</div>
	</div>
</div>
<!-- ********************中间内容-结束******************** -->
