...
<div class="rent_car">
	...
	<dl class="dl1">
		<dt id="rent_cardl1_dt">
			<a href="/rent/car" class="a1">汽车租赁</a>
			<a href="/rent/car2">客车包租</a>
			<a href="/rent/car2">约租</a>
		</dt>
		<dd>
				...
				<div class="dd1_right">
					...
					<div>
						<select name="id11" id="id11" style="height: 40px;margin-left: 98px;width: 425px;">
				            <option value="0" <#if id11?? && id11==0>selected="selected"</#if>>&nbsp;&nbsp;请选择汽车</option>
				        	<#if rent_car_page11??>
				        	   <#list rent_car_page11.content as item>
        ...
        <#if rent_car_page.totalPages gt 0>
            ...
            <#list 1..rent_car_page.totalPages as page>
                <#if page <= 3 || (rent_car_page.totalPages-page) < 3 || (rent_car_page.number+1-page)?abs<3 >
                    ...
                    <#else>
                        <dd>
                            <a href="/rent/car?page=${page-1}">${page}</a>
                        </dd>
                    </#if>
                    <#assign continueEnter=false>
                <#else>
