...
<div class="percenter_com detail_page">
	...
	<dl class="goods_detail">
		...
		<dd>
			...
			<p class="p5">
				<label class="la1">途经港口：<span>${goods.passPort!''}</span></label>
			</p>
			<p class="p3" id="showNum" style="display:none;">
				<label class="la1">选择人数：成人：<input type="number" min="0" id="chengrenshu" style="width:35px" onchange="hanshu();" value="0" onkeydown="return checkNumber(event);">儿童：<input type="number" min="0" id="ertongshu" onchange="hanshu();" onkeydown="return checkNumber(event);" value="0" style="width:35px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总价：<span id="zongjia">0.00</span>元</label>
			</p>
...
function AjaxTimes(id) {
	...
	<div class="steamship">
		<ul id="steamship_ul">
			<li class="li1"><a href="#ta1">邮轮介绍</a></li>
		...
		<p class="ship_title"><a name="ta1">邮轮介绍</a></p>
		<p class="ship_word">
