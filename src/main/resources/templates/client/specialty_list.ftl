...
<title><#if setting??>${setting.seoTitle!''}-</#if>特产</title>
...
<div class="index_banner">
		<div class="banner_scrool">
			<#if big_scroll_ad_list7??>
				<#list big_scroll_ad_list7 as item>
	...
	<div class="boat_list">
		<div class="boat_left">
			...
			<div class="boat_left02">
				...
				<ul>
					<li>
						<a href="/list/${category.id?c}<#if param_index_list??><#list param_index_list as pidx>-${pidx?c}</#list></#if><#if sortId??>-${sortId?c}</#if><#list 0..2 as sid><#if sid==sortId><#else>-0</#if></#list><#if pageId??>-${pageId!''}</#if>_1-100">1-100</a>
					</li>
					<li>
						<a href="/list/${category.id?c}<#if param_index_list??><#list param_index_list as pidx>-${pidx?c}</#list></#if><#if sortId??>-${sortId?c}</#if><#list 0..2 as sid><#if sid==sortId><#else>-0</#if></#list><#if pageId??>-${pageId!''}</#if>_101-200">101-200</a>
					</li>
					<li>
						<a href="/list/${category.id?c}<#if param_index_list??><#list param_index_list as pidx>-${pidx?c}</#list></#if><#if sortId??>-${sortId?c}</#if><#list 0..2 as sid><#if sid==sortId><#else>-0</#if></#list><#if pageId??>-${pageId!''}</#if>_201-500">201-500</a>
					</li>
					<li>
						<a href="/list/${category.id?c}<#if param_index_list??><#list param_index_list as pidx>-${pidx?c}</#list></#if><#if sortId??>-${sortId?c}</#if><#list 0..2 as sid><#if sid==sortId><#else>-0</#if></#list><#if pageId??>-${pageId!''}</#if>_501-700">501-700</a>
					</li>
					<li>
						<a href="/list/${category.id?c}<#if param_index_list??><#list param_index_list as pidx>-${pidx?c}</#list></#if><#if sortId??>-${sortId?c}</#if><#list 0..2 as sid><#if sid==sortId><#else>-0</#if></#list><#if pageId??>-${pageId!''}</#if>_701-1000">701-1000</a>
					</li>
					<li>
						<a href="/list/${category.id?c}<#if param_index_list??><#list param_index_list as pidx>-${pidx?c}</#list></#if><#if sortId??>-${sortId?c}</#if><#list 0..2 as sid><#if sid==sortId><#else>-0</#if></#list><#if pageId??>-${pageId!''}</#if>_1000-">1000以上</a>
					</li>
					<li class="li01">
				...
				<#if goods_page??>
					...
					<dl>
						...
						<dd>
							...
							<span></span>
							<div class="div1">
								<div class="left">￥${item.salePrice?string("0.00")}元</div>
								<a href="/order/specialty?id=${item.id?c}" target="_blank">立即下单</a>
							</div>
