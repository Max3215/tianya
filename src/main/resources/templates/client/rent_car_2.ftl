...
<div class="rent_car">
	...
	<dl class="dl1">
		<dt id="rent_cardl1_dt">
			...
			<a href="/rent/car_long" <#if type?? && type='long'>class="a1"</#if>>长租服务</a>
			<a href="/rent/car2" <#if type?? && type='long'><#else>class="a1"</#if> >包车服务</a>
			<a href="/rent/car3">约租</a>
			<a href="/rent/driveStead" >代驾</a>
		</dt>
		<dd>
			<form action="/rent/search222" method="post">
				<#--
				<div class="dd1_left">
				...
				<div class="dd1_right" style="text-align:center;width:100%;">
					<div hidden="hidden">
					...
					<div style="text-align:center;width:100%;  margin-top: 35px;">
						<select name="st" id="id11" style="height: 40px;margin-left: 0;width: 425px; ">
				            <option value="" selected="selected">&nbsp;&nbsp;请选择车型</option>
				            <#if subtitleList??>
					            <#list subtitleList as s>
					        		<option value="${s!''}" <#if subTitle?? && subTitle=="${s!''}">selected="selected"</#if>>${s!''}</option>    	
					            </#list>				            	
				            </#if>
				            <#--
					...
					<input type="submit" value="搜索" class="searc" style="display:inline-block;margin-left:0;float: initial;">
				</div>
			</form>
		</dd>
	</dl>
