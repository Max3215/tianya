...
<div class="percenter_com detail_page">
	...
	<dl class="goods_detail">
		...
		<dd>
			...
			<p class="p4">
				<label class="la1">取车地点：<span>${goods.leavePort!''}</span></label>
				<label class="la2">还车地点：<span>${goods.reachPort!''}</span></label>
			</p>
			<p class="p5">
				<label class="la1">途径地点：<span>${goods.passPort!''}</span></label>
			</p><p class="p6">
				<label class="la1">汽车公司：<span>${goods.shipCompany!''}</span></label>
			</p>
	...
	<div class="steamship">
		<ul id="steamship_ul">
			<li class="li1"><a href="#ta1">汽车介绍</a></li>
