...
<div class="tab-content">
  ...
  <dl>
    <dt>活动标题</dt>
    <dd>
      <textarea name="tdTitle" rows="2" cols="20" class="input normal"><#if pay_type??>${pay_type.tdTitle!''}</#if></textarea>
  ...
  <dl>
    <dt>活动内容</dt>
    <dd>
      <textarea name="tdContents" rows="2" cols="20" class="input normal"><#if pay_type??>${pay_type.tdContents!''}</#if></textarea>
