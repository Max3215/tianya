  ...
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        ...
        <#if (tdManagerRole?? && tdManagerRole.isSys) || (manager?? && manager.canUpDown?? && manager.canUpDown)>
            <li><a onclick="return ExePostBack('btnDelete');" id="btnDelete" class="del" href="javascript:__doPostBack('btnDelete','')"><i></i><span>删除</span></a></li>
            <li><a  class="" href="javascript:__doPostBack('btnSaleAll','')"><i></i><span>批量上架</span></a></li>
            <li><a  class="folder" href="javascript:__doPostBack('btnDownAll','')"><i></i><span>批量下架</span></a></li>
        </#if>
      </ul>
      <div class="menu-list">
        ...
        <tr>
            ...
            <td>
              <div class="btn-tools">
                ...
                <a title="效果预览" class="record"  href="/Verwalter/managerApply/goodsDetail?id=${content.id?c}"></a>
                <#--
