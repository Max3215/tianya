            ...
            <dd>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span id="spanShopId">${order.shopId!""} 天</span></td>
                    </tr>
                    <tr>
                        <th>
                            代驾还是自驾？
                        </th>
                        <td><span id="spanShopId1">${order.deliveryPerson!""}</span></td>
                    </tr>
                    <tr>
                        <th>
                            取车时间
                        </th>
                        <td><span id="spanShopId11">${order.appointmentTime!""}</span></td>
                    </tr>
                    <tr>
                        <th>
                            取车地区
                        </th>
                        <td><span id="spanShopId11"><#if goods??>${goods.qcdd!''}</#if></span></td>
                    </tr>
                    <tr>
                        <th>
                            取车地址
                        </th>
                        <td><span id="spanShopId11"><#if goods??>${goods.qcdz!''}</#if></span></td>
                    </tr>
                    <tr>
                        <th>
                            还车时间
                        </th>
                        <td><span id="spanShopId111">${order.returnTime!""}</span></td>
                    </tr>
                    <tr>
                        <th>
                            还车地区
                        </th>
                        <td><span id="spanShopId111"><#if goods??>${goods.hcdd!''}</#if></span></td>
                    </tr>
                    <tr>
                        <th>
                            还车地址
                        </th>
                        <td><span id="spanShopId111"><#if goods??>${goods.hcdz!''}</#if></span></td>
                    </tr>
                    <tr>
                        <th>
                            电话
