...
<form name="form1" method="post" action="/Verwalter/bargain/record/list" id="form1">
<div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tbody>
	<tr class="odd_bg">
	    <th width="8%">选择</th>
	    <th align="left" width="15%">砍价用户</th>
	    <th align="left" width="15%">帮助用户</th>
	    <th width="8%">帮助用户电话</th>
	    <th align="center">砍价金额</th>
	    <th align="left" width="12%">剩余金额</th>
	    <th align="left" width="12%">砍价时间</th>
    </tr>
    <#if record_page??>
        <#list record_page.content as item>
           <tr>
                <td align="center">
                ...
                <td><#if item.newPrice??>${item.newPrice?string("0.00")}</#if></td>
                <td><#if item.cutTime??>${item.cutTime?string("yyyy-MM-dd")}</#if></td>              
            </tr>
        </#list>
    </#if>
