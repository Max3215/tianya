...
<title>后台管理中心</title>
<link rel="shortcut icon" href="/mag/style/tianya.ico">
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    function remind(){    
         $.ajax({
                type: "post",
                url: "/Verwalter/remaind",
                data: {},
                dataType: "json",
                success: function (data) {   
                     if (data.code == 0) {
                     	//alert("ok");
                        if(data.newApplyNum>newApplyNum){
                            //alert("您有" + data.newApplyNum + "条申请待审核");
                            //alert("您有新的审核");
                            SimplePop.alert("您有新的审核");
                        }
                        
                        newApplyNum = data.newApplyNum;
                        
                        if(data.toSureNoticeNum>toSureNoticeNum){
                         //   alert("您有新的通知");
                            SimplePop.alert("您有新的通知");
                        }
                        toSureNoticeNum = data.toSureNoticeNum;
                        
                        if(data.orderNum>orderNum && orderNum !=0){
                           // alert("您有新的订单");
                            SimplePop.alert("您有新的订单");
                        }
                        orderNum = data.orderNum;
                        
                        if(data.privateNum>privateNum && privateNum !=0){
                           // alert("您有新的私家定制");
                            SimplePop.alert("您有新的私家定制");
                        }
                        privateNum = data.privateNum;
                        
                        if(data.visitorNum>visitorNum && visitorNum !=0){
                           // alert("您有新的游客定制");
                            SimplePop.alert("您有新的游客定制");
                        }
                        visitorNum = data.visitorNum;
                        
                        if(data.yzNum>yzNum && yzNum !=0){
                           // alert("您有新的约租服务");
                            SimplePop.alert("您有新的约租服务");
                        }
                        yzNum = data.yzNum;
                        
                        if(data.djNum>djNum && djNum !=0){
                            // alert("您有新的代驾服务");
                            SimplePop.alert("您有新的代驾服务");
                        }
                        djNum = data.djNum;
                    } 
                }
          ...
          <div class="header-box">
            ...
            <div class="nav-right">
              <div class="icon-info">
                ...
                <span>
                  您好，${manager!''}<br>
                  <#if roleName??>${roleName!''}<#else>超级管理组</#if>
                </span>
