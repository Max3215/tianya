...
<form name="form1" method="post" action="/Verwalter/user/commenttravel/list" id="form1">
<div>
                ...
                <td class="comment">
                  <div class="title">
                    <span class="note">
                        ...
                        <i class="reply">
                            <a href="/Verwalter/user/commenttravel/edit?id=${comment.id?c}&statusId=${statusId!""}">回复</a>
                        </i>
                    </span>
                    <b>
