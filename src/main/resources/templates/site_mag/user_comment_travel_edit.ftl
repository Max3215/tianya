...
<form name="form1" method="post" action="/Verwalter/user/commenttravel/save" id="form1">
<div>
<input type="hidden" name="__VIEWSTATE" value="${statusId!""}">
<input type="hidden" name="userTravelCommentId" value="${userTravelCommentId!""}">
</div>
<!--导航栏-->
<div class="location">
  <a href="/Verwalter/user/commenttravel/list?statusId=${statusId!""}" class="back"><i></i><span>返回列表页</span></a>
...
<div class="tab-content">
  <dl>
    <dt>文章标题</dt>
    <dd><#if user_comment??>${user_comment.title!""}</#if></dd>
  </dl>
  <dl>
    <dt>评论用户</dt>
