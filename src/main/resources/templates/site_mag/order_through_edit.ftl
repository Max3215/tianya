                ...
                <table border="0" cellspacing="0" cellpadding="0" class="border-table" width="98%">
                   ...
                   <#-- 
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="position">
                                ...
                                <#if  order.statusId==2 && order.isOnlinePay?? && order.isOnlinePay >
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="position">
                                <span id="spanRealAmountValue1">
                                    <#if order.shopId??>${order.shopId!'0'}</#if>
                                </span> 人
                            </div>
                        </td>
                    </tr>    
                    <tr>
                        ...
                        <td>
                            <div class="position">
                                <span id="spanRealAmountValue11">
                                    <#if order.ertongshu??>${order.ertongshu!0}<#else>0</#if>
                                </span> 人
                            </div>
                        </td>
                    </tr>    
                   ...
                   -->
                    ...
                    <tr>
                        ...
                        <td><#if order.leaveDate??>${order.leaveDate?string("yyyy-MM-dd HH:mm:ss")}</#if></td>
                    </tr>
                    <#--
                    <tr>
                        <th>
