...
<div class="tab-content">
  <dl>
    <dt>部门名称</dt>
    <dd>
        <input name="department" type="text" value="<#if service_item??>${service_item.department!""}</#if>" class="input normal" datatype="*1-255" sucmsg=" "> 
        <span class="Validform_checktip">*部门名称</span>
    </dd>
  </dl>
  <dl>
    <dt>服务QQ</dt>
    <dd>
        <input name="qq" type="text" value="<#if service_item??>${service_item.qq!""}</#if>" class="input normal" datatype="*1-255" sucmsg=" "> 
        <span class="Validform_checktip">*服务QQ</span>
    </dd>
  </dl>
  <dl>
    <dt>是否启用</dt>
