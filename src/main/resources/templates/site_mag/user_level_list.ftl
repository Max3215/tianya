  ...
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      <ul class="icon-list">
        ...
        <#if existUser?? && existUser="yes">
        	<input type="text" value="yes" hidden="hidden" id="existUser">
        </#if>
      </ul>
    </div>
  </div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    ...
    <th align="center" width="12%">要求达到的最低积分</th>
    <#--<th width="6%">优惠比例</th>-->
    <th width="6%">优惠折扣</th>
    <th width="8%">是否启用</th>
    <th width="8%">排序号</th>
    ...
    <#if user_level_page??>
        <#list user_level_page.content as level>
            <tr>
                ...
                <td align="center"><#if level.requiredPoints??>${level.requiredPoints?c} 分<#else>0 分</#if></td>
