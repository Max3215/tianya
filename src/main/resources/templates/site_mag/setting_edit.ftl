...
<form method="post" action="/Verwalter/setting/save" id="form1">
    ...
    <div class="tab-content" style="display: block;">
        ...
        <dl>
            <dt>国内服务</dt>
            <dd>
                <input name="qq2" type="text" value="<#if setting??>${setting.qq2!""}</#if>" class="input normal" datatype="*" sucmsg=" ">
                <span class="Validform_checktip"></span>
            </dd>
        </dl>
        <#--
        ...
        <dl>
            <dt>邮箱</dt>
            <dd>
                <input name="adminEmail" type="text" value="<#if setting??>${setting.adminEmail!""}</#if>" class="input normal" >
                <span class="Validform_checktip"></span>
            </dd>
        </dl>
        <dl>
