...
//自动计算成本价	
	...
	function changePrice(){
	     ...
	     $("#costPrice").val((parseFloat(p3) + parseFloat(p5) + parseFloat(p7) + parseFloat(p6) + parseFloat(p8) + parseFloat(p3)*parseFloat(p11)).toFixed(2));
	     $("#shopReturnProfit").val((parseFloat(p4) - parseFloat(p3) - parseFloat(p5) - parseFloat(p6) - parseFloat(p7) - parseFloat(p8) - (parseFloat(p3)*parseFloat(p11)) - (parseFloat(p4) * ( parseFloat(p9) + parseFloat(p10)))).toFixed(2));
	     $("#shopReturn").val((parseFloat(p4) * parseFloat(p9)).toFixed(2));
	     $("#trainServiceReturnProfit").val((parseFloat(p3) * parseFloat(p11)).toFixed(2));
	     $("#platformServiceReturnProfit").val((parseFloat(p4) * parseFloat(p10)).toFixed(2));
	}