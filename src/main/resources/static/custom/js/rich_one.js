...
function win_guide(){
	...
	window.onscroll = function(){
		...
		//console.log(scro)
		if(scro>posit01 && saw>wi && scro<posit09){
			oGui.style.display = 'block';
		}else{
			oGui.style.display = 'none';
		};

		if(scro>=posit01 &&scro<posit02 ){
			all_hide();
			aDd[0].className = 'yell';
			aSpan[0].style.display = 'block';
		}else if(scro>=posit02 && scro<posit03){
			all_hide();
		...
		}else if(scro>=posit05 && scro<posit09){
			all_hide();
