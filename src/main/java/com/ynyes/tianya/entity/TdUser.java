...
public class TdUser {
    ...
    /*@OneToMany
	@JoinColumn(name="userId")
    private List<TdUserVisitor> tdUserVisitorList;*/
	...
	public Long getDefaultVisitorId() {
		return defaultVisitorId;
	}

	public void setDefaultVisitorId(Long defaultVisitorId) {
		this.defaultVisitorId = defaultVisitorId;
	}
