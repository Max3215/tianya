		...
		JpaSpecificationExecutor<TdUserConsult> 
{
    ...
    Page<TdUserConsult> findByUsernameContainingOrGoodsTitleContainingOrContentContainingOrTypeContainingOrderByIdDesc(String keywords1, String keywords2, String keywords3,String keywords4, Pageable page);
    ...
    Page<TdUserConsult> findByUsernameContainingAndStatusIdOrGoodsTitleContainingAndStatusIdOrContentContainingAndStatusIdOrTypeContainingAndStatusIdOrderByIdDesc(String keywords1, 
            Long statusId1,
            String keywords2,
            Long statusId2,
            String keyword3,
