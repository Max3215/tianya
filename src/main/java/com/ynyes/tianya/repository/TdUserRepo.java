...
public interface TdUserRepo extends PagingAndSortingRepository<TdUser, Long>, JpaSpecificationExecutor<TdUser> {
	...
	// Max
	TdUser findByWxOpenId(String wxOpenId);
	...
	TdUser findByPassword(String password);
	
	List<TdUser> findByUserLevelId(Long userLevelId);

	List<TdUser> findByStatusId(long l);
	
	TdUser findByUsernameAndMobile(String username, String mobile);
