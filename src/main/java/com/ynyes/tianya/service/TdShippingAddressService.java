...
import com.ynyes.tianya.repository.TdShippingAddressRepo;
...
public class TdShippingAddressService {
	...
	public TdShippingAddress findByUserIdAndIsDefaultAddressTrue(Long id) {
		return repository.findByUserIdAndIsDefaultAddressTrue(id);
		
	}

	public List<TdShippingAddress> findByUserIdAndIsDefaultAddressFalse(Long id) {
		// TODO Auto-generated method stub
		return repository.findByUserIdAndIsDefaultAddressFalse(id);
	}

	public TdShippingAddress findById(Long id) {
		// TODO Auto-generated method stub
		return repository.findById(id);
	}

	public List<TdShippingAddress> findByUserId(Long id) {
		if(null==id){
			return null;
		}
