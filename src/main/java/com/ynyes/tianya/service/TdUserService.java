...
import com.ynyes.tianya.repository.TdUserRepo;
...
public class TdUserService {
    ...
    public TdUser addNewUser(String username, String password, String mobile, String email)
    {
    ...
    */
    ...
    public TdUser findByWxOpenId(String wxOpenId){
    	if(null == wxOpenId){
    		return null;
    	}
    ...
    public TdUser save(TdUser e)
    {
       ...
       {
    	   TdUserLevel level = tdUserLevelService.findOne(e.getUserLevelId());
    	   if(null != level)
    	   {
	...
	public TdUser findByPassword(String password)
    {
        if (null == password)
        {
            return null;
	...
	public List<TdUser> findByUserLevelId(Long userLevelId){
		if(userLevelId == null){
			return null;
		}
		
		return repository.findByUserLevelId(userLevelId);
		
	}

	public List<TdUser> findByStatusId(long l) {
		// TODO Auto-generated method stub
		return repository.findByStatusId(l);
	}
	
	public TdUser findByUsernameAndMobile(String username, String mobile){
		return repository.findByUsernameAndMobile(username, mobile);
	}
