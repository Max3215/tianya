...
public class TdManagerProductController {
	...
	public String parameter(@PathVariable Long id, Long goodsId, ModelMap map, HttpServletRequest req) {
	...
	public String setting(Integer page, Integer size, String keywords, String __EVENTTARGET, String __EVENTARGUMENT,
			String __VIEWSTATE, Long[] listId, Integer[] listChkId, Long[] listSortId, ModelMap map,
	...
	public String orderEdit(TdProduct tdProduct, String __VIEWSTATE, ModelMap map, HttpServletRequest req) {
		String username = (String) req.getSession().getAttribute("manager");
		if (null == username) {
			return "redirect:/Verwalter/login";
		}
