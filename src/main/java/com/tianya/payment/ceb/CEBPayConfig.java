...
public class CEBPayConfig {
     ...
     * 本行支付提交商户ID
     */
    public static final String INNER_MERCHANT_ID = "394810000074";
//    public static final String INNER_MERCHANT_ID = "370310000004";
//    public static final String INNER_MERCHANT_ID = "365010000133";
    /*
     * 跨行支付提交商户ID
     */
    public static final String INTER_MERCHANT_ID = "394810000074";
